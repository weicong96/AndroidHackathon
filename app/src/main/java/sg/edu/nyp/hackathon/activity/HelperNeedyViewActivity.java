...
public class HelperNeedyViewActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_helper_needy_view);

        LoginUtils.getInstance(this).loginFromDevice();
