...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public Patch patch(java.lang.Long userID, com.example.admin.myapplication.backend.userApi.model.User content) throws java.io.IOException {
    Patch result = new Patch(userID, content);
    initialize(result);
    return result;
  }

  public class Patch extends UserApiRequest<com.example.admin.myapplication.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.Long userID, com.example.admin.myapplication.backend.userApi.model.User content) {
      super(UserApi.this, "PATCH", REST_PATH, content, com.example.admin.myapplication.backend.userApi.model.User.class);
      this.userID = com.google.api.client.util.Preconditions.checkNotNull(userID, "Required parameter userID must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.Long userID, com.example.admin.myapplication.backend.userApi.model.User content) throws java.io.IOException {
    Update result = new Update(userID, content);
    initialize(result);
    return result;
  }

  public class Update extends UserApiRequest<com.example.admin.myapplication.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.Long userID, com.example.admin.myapplication.backend.userApi.model.User content) {
      super(UserApi.this, "PUT", REST_PATH, content, com.example.admin.myapplication.backend.userApi.model.User.class);
      this.userID = com.google.api.client.util.Preconditions.checkNotNull(userID, "Required parameter userID must be specified.");
    }
